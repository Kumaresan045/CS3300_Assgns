...
public class PassTwo<R,A> implements GJVisitor<R,A> {
   //
   ...
   //Constructor
   public PassTwo(ClassInfo hoistData) 
   {
   ...
   public void TypeCheckHoist()
   {
      ...
      for (String key : hoistData.parentMap.keySet())
      {
         ...
         if(parent != null && !hoistData.exists(parent)) notfounderror();
      }
      ...
      for (Map<String,String> fieldMap : hoistData.fieldList)
      {
         for (String key : fieldMap.keySet())
         {
            ...
            if(Nonprimitive(type) && !hoistData.exists(type)) notfounderror();
         }
      }
      ...
      for(Map<String,MethodData> methodMap : hoistData.methodList)
      {
         for (String key : methodMap.keySet())
         {
            ...
            if(Nonprimitive(returntype) && !hoistData.exists(returntype)) notfounderror();
            for (String argtype : methodData.argtypes)
            {
               if(Nonprimitive(argtype) && !hoistData.exists(argtype)) notfounderror();
            }
      ...
      for(int i=0; i< hoistData.classOrder.size(); i++)
      {
         ...
         Map<String,MethodData> allMethods = hoistData.methodList.get(i);
   ...
   public String getmethodtype(String classname, String methodname, Vector<String> argtypes)
   {
      ...
      if(methodMap.containsKey(methodname))
      {
         ...
         if(methodData.argtypes.size() != argtypes.size()) error();
         for(int i=0; i<argtypes.size(); i++)
         {
            if(!Subtype(argtypes.get(i), methodData.argtypes.get(i))) error();
         }
   ...
   public R visit(MethodDeclaration n, A argu) {
      ...
      n.f8.accept(this, argu);
      n.f9.accept(this, argu);
      R exp_typ = n.f10.accept(this, argu);
      n.f11.accept(this, argu);
      n.f12.accept(this, argu);
      int indx = hoistData.classOrder.indexOf(hoistData.domainclass);
      Map<String,MethodData> methodata = hoistData.methodList.get(indx);
      String ret_signature = methodata.get(hoistData.domainmethod).returntype;
      if((exp_typ != (R)ret_signature) && (!(Nonprimitive(ret_signature) && Nonprimitive((String)exp_typ)) || !Subtype((String)exp_typ, ret_signature))) error();
      return _ret;
   }
   ...
   public R visit(AssignmentStatement n, A argu) {
      ...
      if((idtype!=exprtype) && (!(Nonprimitive((String)idtype) && Nonprimitive((String)exprtype)) || !Subtype((String)exprtype, (String)idtype))) error();
      n.f3.accept(this, argu);
      return _ret;
   }
   ...
   public R visit(MessageSend n, A argu) {
      ...
      Vector<String> tempargtypes = new Vector<String>();
      ...
      if(nodeopt.present())
      {
         ...
         String type = (String) exprlist.f0.accept(this, argu);
         ...
         if(exprlistrest.present())
         {
            for(Node node : exprlistrest.nodes)
            {
               ...
               type = (String) exprrest.f1.accept(this, argu);
               tempargtypes.add(type);
            }
         }
      }
      ...
      String ret_type = getmethodtype((String)typ1,methodname,tempargtypes);
      _ret = (R)ret_type;
      return _ret;
   }
   ...
   public R visit(AllocationExpression n, A argu) {
      ...
      if(!hoistData.exists(clsname)) notfounderror();
